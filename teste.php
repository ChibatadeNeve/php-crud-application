    ...
    <body>
        ...
        <main>
            <section class="formulario">
                ...
                <form method="POST" class="formulario">
                    ...
                    <button type="submit" name="acao" value="inserir">Salvar</button>
        ...
        require_once "funcoes.php"; // funções de validação

        // Variáveis de GET e POST
        $acao = $_GET['acao'] ?? '';
        $id = $_GET['id'] ?? 0;
        ...
        if ($acao === "excluir" && $id > 0) {
            ...
            header("Location: crud.php"); // atualiza a tabela
            exit;
        }
